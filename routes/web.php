...
Route::get('/', function () {
    ...
    if (!session()->has('east_splash_shown')) {
        ...
        return view('pages/splash/index'); // show splash page
    }

    return view('pages/homepage/index'); // normal home/landing page
});

// --------------------------------------------------------------------

// Route::get('/', function (Request $request) {
//     if (!$request->session()->has('east_splash_shown')) {
...
// Route::get('/splash', function (Request $request) {
//     if ($request->session()->has('east_splash_shown')) {
...
// Route::post('/splash/complete', function (Request $request) {
//     $request->session()->put('east_splash_shown', true);
