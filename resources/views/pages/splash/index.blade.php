...
<head>
    ...
    <style>
        * {
        ...
        /* When class 'start-animation' is added, play animation */
...
<body>
    <svg id="logo" width="681" height="202" viewBox="0 0 681 202" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M137.318 5.04547V46.5914H52.5V79.773H130.682V121.409H52.5V154.682H137.318V196.227H2.5V5.04547H137.318Z"
    ...
    <script>
        ...
        const initialDelay = 2000; // 2 seconds before animation starts
        ...
        setTimeout(() => {
            ...
            // Fade out and redirect after animation finishes
            setTimeout(() => {
                document.body.classList.add('fade-out');

                setTimeout(() => {
                    window.location.href = "{{ url('/') }}"; // go to home page
                }, fadeDuration);
